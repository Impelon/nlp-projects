...
def show_pattern_by_language():
    ...
    for lang in LANGUAGES:
        ...
        for lang_line, en_line in loader.iterate_dataset(lang):
            ...
            language_codes[lang].update(pre.PATTERNS_TO_REPLACE["language_code"][0].findall(lang_line))
            language_codes[f"EN ({lang})"].update(pre.PATTERNS_TO_REPLACE["language_code"][0].findall(en_line))
    year_dfs = []
    language_code_dfs = []
